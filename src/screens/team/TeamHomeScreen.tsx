...
import { listPatients, setPatientActive, getTeamAgendaToday, getTeamAdherence, PatientRow, TeamAgendaItem } from '../../lib/api';
import { appointmentMeta, roleMeta } from '../../data/helpers';
import { AppointmentType, Role } from '../../data/types';
import { TeamStackParams } from '../../navigation/TeamNavigator';
